...
if __name__ == '__main__':
    ...
    print(findMinHeightTrees(6, [[0, 1], [0, 2], [0, 3], [3, 4], [4, 5], [5, 6]]))  # [3, 4]
    print(findMinHeightTrees(6, [[0, 1], [0, 2], [0, 3], [3, 4], [4, 5], [5, 6], [6, 7]]))  # [4, 5]
    print(findMinHeightTrees(6, [[0, 1], [0, 2], [0, 3], [3, 4], [4, 5], [5, 6], [6, 7], [7, 8]]))  # [5, 6]
